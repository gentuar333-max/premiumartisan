    ...
    <div className="min-h-screen bg-[#f0f2f5]">
      <header className="sticky top-0 z-30 bg-[#eaecef] border-b border-[#d5d8dc] shadow-sm">
        <div className="mx-auto flex h-[52px] max-w-7xl items-center gap-2 px-4 sm:px-6 overflow-x-auto">
          ...
          {/* ── 🎙 Réceptionniste IA — NOUVEAU ── */}
          <Link
            href="/artisan/receptionist"
            className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 text-sm font-semibold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-lg whitespace-nowrap transition border border-emerald-200"
          >
        ...
        <>
          ...
          <aside className="fixed right-0 top-0 z-50 flex h-full w-[300px] max-w-[80vw] flex-col bg-white shadow-2xl">
            ...
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {/* ── 🎙 Réceptionniste IA në menu lateral — NOUVEAU ── */}
              <Link
                href="/artisan/receptionist"
                className="w-full rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-center text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100 flex items-center justify-center gap-2"
