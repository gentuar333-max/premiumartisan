...
export const metadata = {
  ...
  description: "Mentions légales de PremiumArtisan — plateforme de mise en relation artisans et particuliers à Dijon et en Côte-d'Or (21). Éditeur, hébergeur, contact.",
};
