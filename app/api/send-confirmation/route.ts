...
<head>
  ...
  <title>Votre projet a été publié</title>
</head>
          ...
          <tr>
            <td style="padding:28px 32px;">
              <p style="margin:0 0 20px;font-size:15px;color:#334155;">
                ...
                Votre projet a bien été enregistré. Voici un récapitulatif :
              </p>
              ...
              <div style="background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:14px 16px;margin-bottom:24px;">
                <p style="margin:0;font-size:13px;color:#1e40af;line-height:1.6;">
                  ⚡ <strong>Maximum 3 artisans</strong> auront accès à vos coordonnées.<br/>
                  Vous pouvez recevoir des appels dans les prochaines heures.
                </p>
              </div>
              ...
              <div style="text-align:center;margin-bottom:24px;">
                <p style="margin:0 0 14px;font-size:14px;color:#334155;font-weight:600;">
                  ✅ Une dernière étape — confirmez votre email pour activer votre projet :
                </p>
                <a href="${confirm_url}"
                  style="display:inline-block;background:linear-gradient(135deg,#2563eb,#4f46e5);color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:12px;font-weight:800;font-size:15px;letter-spacing:0.3px;box-shadow:0 4px 14px rgba(99,102,241,0.4);">
              ...
              <p style="margin:0;font-size:13px;color:#94a3b8;text-align:center;">
                Merci d'avoir fait confiance à Premium Artisan.<br/>
                <a href="https://premiumartisan.fr" style="color:#2563eb;text-decoration:none;">premiumartisan.fr</a>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:16px 32px;text-align:center;">
              <p style="margin:0;font-size:11px;color:#94a3b8;">
                © ${new Date().getFullYear()} Premium Artisan · Vous recevez cet email car vous avez publié un projet sur notre plateforme.
              </p>
            </td>
          </tr>
