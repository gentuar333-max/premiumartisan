...
const FAQ_ITEMS = [
  ...
  { q: "Combien de temps faut-il pour trouver un artisan peintre à Dijon ?", a: "Sur PremiumArtisan, vous recevez vos premiers devis en 3 à 6h. Le délai moyen pour démarrer un chantier est de 1 à 3 semaines selon la saison." },
  { q: "Les artisans à Dijon sont-ils disponibles rapidement ?", a: "Oui, notre réseau compte 47 artisans peintres actifs à Dijon et en Côte-d'Or. En basse saison, la disponibilité est excellente. En été, prévoyez 2 à 4 semaines de délai." },
  ...
  { q: "Est-ce gratuit de publier un projet sur PremiumArtisan ?", a: "Oui, la publication d'un projet est 100% gratuite pour les particuliers. Vous recevez jusqu'à 4 devis sans engagement." },
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <span className="text-[15px] font-bold text-white" style={{ fontFamily: "serif" }}>
          Peinture Intérieure — Dijon
        </span>
        <div className="hidden items-center md:flex">
          {["47 artisans vérifiés", "25–45€/m²", "Réponse en 3h", "4.8/5 · 127 avis"].map((t, i) => (
      ...
      <a
        href="/publier-projet"
        className="shrink-0 rounded-[10px] px-5 py-2 text-[13px] font-bold text-white transition hover:-translate-y-px"
    ...
    >
      ...
      <div className="flex flex-wrap gap-2.5">
        ...
        <button
          ...
          className="h-12 rounded-xl px-6 text-[15px] font-bold text-white transition hover:-translate-y-0.5"
      ...
      <div className="mt-2.5 flex flex-wrap gap-3.5">
        {["Sans engagement", "Max 4 artisans", "Données protégées", "847 projets analysés"].map((t, i) => (
          <span key={i} className="text-[12px] font-semibold text-white/42">
...
function MidPageCTA() {
  return (
    <div
      className="mt-9 flex flex-wrap items-center justify-between gap-6 rounded-[20px] p-8"
      style={{ background: "linear-gradient(135deg, #1e3a5f 0%, #0a2240 100%)", border: "1px solid rgba(255,255,255,0.07)" }}
    >
      <div>
        <h3 className="mb-1.5 text-[22px] font-bold text-white" style={{ fontFamily: "serif" }}>
          Ces prix correspondent à votre projet ?
        </h3>
        <p className="text-[14px] text-white/58">
          Obtenez une estimation précise de 3 artisans vérifiés à Dijon.
        </p>
        <div className="mt-2.5 flex flex-wrap gap-4">
          {[["847", "projets analysés"], ["4.8/5", "satisfaction"], ["sous 3h", "réponse"], ["4 max", "artisans"]].map(([v, l], i) => (
            <span key={i} className="text-[13px] font-semibold text-white/52">
              <strong className="text-white/88">{v}</strong> {l}
            </span>
          ))}
        </div>
      </div>
      <div className="flex shrink-0 flex-col items-end gap-1.5">
        <a
          href="/publier-projet"
          className="rounded-[13px] px-6 py-3 text-[15px] font-bold text-white transition hover:-translate-y-0.5"
          style={{ background: "linear-gradient(135deg, #c8531a, #e8832a)", boxShadow: "0 8px 24px rgba(200,83,26,0.38)" }}
        >
...
function SidebarCTA() {
  return (
    <div
      ...
      style={{ background: "linear-gradient(135deg, #1e3a5f, #0a2240)", border: "1px solid transparent" }}
    >
      <h4 className="mb-2.5 text-base font-bold text-white" style={{ fontFamily: "serif" }}>
        Prêt à démarrer ?
      </h4>
      <p className="mb-4 text-[13px] leading-relaxed text-white/58">
        Recevez 3 devis de peintres vérifiés à Dijon sous 3h. Gratuit, sans engagement.
      </p>
      <a
        href="/publier-projet"
        className="block rounded-xl py-3 text-center text-[14px] font-bold text-white transition hover:-translate-y-0.5"
        style={{ background: "linear-gradient(135deg, #c8531a, #e8832a)" }}
      >
        Obtenir mes devis →
      </a>
      <p className="mt-2 text-center text-[11px] text-white/28">847 projets · 4.8/5 · Sans spam</p>
    </div>
  );
}
    ...
    <main className="min-h-screen" style={{ background: "#f8f5ef" }}>
      ...
      <section className="relative overflow-hidden px-8 pb-16 pt-20" style={{ background: "linear-gradient(135deg, #1a1714 0%, #1e3a5f 60%, #1a3a5f 100%)" }}>
        ...
        <div className="relative mx-auto max-w-[900px]">
          ...
          <p className="mb-8 max-w-[600px] text-lg text-white/75">
            Comparez jusqu'à 4 artisans peintres vérifiés à Dijon. Prix moyen constaté : <strong className="text-white">25–45€/m²</strong>. Réponse en 3 à 6h, sans engagement.
          </p>
          ...
          <div className="mb-8 flex flex-wrap gap-4">
            {[
              ...
              { value: "47", label: "Peintres à Dijon" },
          ...
          {/* BUTON SECONDAIRE */}
          <a href="/publier-projet" className="inline-block rounded-2xl bg-[#c8531a] px-10 py-5 text-center text-xl font-bold text-white shadow-[0_12px_32px_rgba(200,83,26,0.4)] transition hover:scale-105 hover:bg-[#e8832a]">
      ...
      <section className="bg-white px-8 py-20" id="prix">
        <div className="mx-auto max-w-[1000px]">
          ...
          <p className="mb-12 max-w-[600px] text-base text-[#7a6f65]">Données collectées sur 847 projets publiés sur notre plateforme en Côte-d'Or. Prix observés entre janvier et mars 2026.</p>
      ...
      {/* QUARTIERS */}
      <section className="bg-[#1a1714] px-8 py-20">
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_1fr]">
            <div className="text-[15px] leading-relaxed text-[#7a6f65]">
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>Devis reçus par projet : <strong>3,2</strong></li>
                <li>Délai 1er contact : <strong>4h</strong></li>
            ...
            <div className="sticky top-6">
              ...
              <div className="mb-4 rounded-2xl border-[1.5px] border-[#e0d8ce] bg-[#f8f5ef] p-6">
                ...
                {[{ k: "Prix moyen mur", v: "32€/m²" }, { k: "Prix moyen plafond", v: "38€/m²" }, { k: "Projets publiés", v: "847" }, { k: "Artisans actifs", v: "47" }, { k: "Satisfaction", v: "4.8/5" }, { k: "Délai réponse", v: "3–6h" }].map((s, i) => (
              ...
              <div className="rounded-2xl border-[1.5px] border-[#e0d8ce] bg-[#f8f5ef] p-6">
                ...
                {[
                  ...
                  { l: "Prix façade Dijon", href: "/devis-facade-dijon" },
                ].map((item, i) => (
        ...
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { title: "Prix façade Dijon 2026", sub: "50–80€/m² · Devis gratuit", href: "/devis-facade-dijon" },
              { title: "Rénovation salle de bain", sub: "3 000€ – 8 000€ · Côte-d'Or", href: "/devis-salle-de-bain-dijon" },
              { title: "Artisan Longvic 21600", sub: "8 artisans · Toutes rénovations", href: "/devis-peinture-longvic" },
              { title: "Guide choisir artisan", sub: "7 critères essentiels", href: "/guide-choisir-artisan" },
              { title: "Prix isolation Bourgogne", sub: "40–80€/m² · Aides MaPrimeRénov", href: "/devis-isolation-dijon" },
              { title: "Baromètre prix 2026", sub: "847 projets analysés Côte-d'Or", href: "/prix-travaux-dijon-2026" },
            ].map((link, i) => (
      ...
      <section className="px-8 py-20 text-center" style={{ background: "linear-gradient(135deg, #1a1714, #1e3a5f)" }}>
        <div className="mx-auto max-w-[1000px]">
          ...
          <h2 className="mb-4 text-3xl font-bold leading-tight text-white md:text-5xl" style={{ fontFamily: "serif" }}>Recevez vos devis gratuits<br />en moins de 6h</h2>
          <p className="mb-3 text-base text-white/70">47 artisans peintres vérifiés à Dijon et en Côte-d'Or. Sans engagement, sans spam.</p>
          <div className="mb-8 flex justify-center gap-5 text-[13px] text-white/45">
            <span>847 projets analysés</span>
            <span>·</span>
            <span>4.8/5 · 127 avis</span>
            <span>·</span>
            <span>Réponse sous 3h</span>
          </div>
          <a href="/publier-projet" className="inline-block rounded-2xl bg-[#c8531a] px-12 py-5 text-center text-xl font-bold text-white shadow-[0_12px_32px_rgba(200,83,26,0.4)] transition hover:scale-105 hover:bg-[#e8832a]">
            🎨 Publiez votre projet gratuitement
          </a>
