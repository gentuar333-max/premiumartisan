...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // ── Nouvelles redirects 404 ──
      { source: "/devis-peinture/marsannay-la-cote",   destination: "/devis-peintre/marsannay-la-cote",  permanent: true },
      { source: "/devis-peinture/grenoble",            destination: "/devis-peintre/dijon",              permanent: false },
      { source: "/devis-peinture/:ville",              destination: "/devis-peintre/:ville",             permanent: true },
      { source: "/logiciel-devis-artisan/lille",       destination: "/logiciel-devis-artisan/dijon",     permanent: false },
      { source: "/logiciel-devis-artisan/saint-etienne", destination: "/logiciel-devis-artisan/dijon",  permanent: false },
      { source: "/devis-peintre/orleans",              destination: "/devis-peintre/dijon",              permanent: false },
    ];
  },
};
